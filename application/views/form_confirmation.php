<!-- Payment Confimation Area Start -->
<div id="order" class="page">
    <div class="container">
      <div class="row" style="margin: 25px 0px;">
        <div class="col-md-12">
          <div class="widget text-center">
              <h2 class="widget-title">Konfirmasi Pembayaran</h2>
          </div>
        </div>
      	...
      	<form method="post">
            ...
            <label>Nomor Handphone:<span style="color:#fc0505">&nbsp;*</span></label>
            <input type="text" name="nama_pemesan" class="form-control" placeholder="Contoh: Budi Sudarsono" autocomplete="off" required />
	        </div>
	        <div class="form-group col-md-6">
	        ...
	        <div class="form-group col-md-12">
            <label>Alamat Lengkap:<span style="color:#fc0505">&nbsp;*</span></label>
